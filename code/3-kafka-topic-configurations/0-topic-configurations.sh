...
kafka-topics.sh --bootstrap-server [::1]:9092 --create --topic configured-topic --partitions 3 --replication-factor 1

# look for existing configurations
kafka-topics.sh --bootstrap-server localhost:9092 --describe --topic configured-topic
kafka-topics.sh --bootstrap-server [::1]:9092 --describe --topic configured-topic
...
kafka-configs.sh --bootstrap-server [::1]:9092 --entity-type topics --entity-name configured-topic --describe
...
kafka-configs.sh --bootstrap-server [::1]:9092 --entity-type topics --entity-name configured-topic --add-config min.insync.replicas=2 --alter
...
kafka-configs.sh --bootstrap-server [::1]:9092 --entity-type topics --entity-name configured-topic --delete-config min.insync.replicas --alter
