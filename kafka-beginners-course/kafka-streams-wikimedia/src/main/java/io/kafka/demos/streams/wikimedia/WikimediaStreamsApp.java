package io.kafka.demos.streams.wikimedia;

import io.kafka.demos.streams.wikimedia.processor.BotCountStreamBuilder;
import io.kafka.demos.streams.wikimedia.processor.EventCountTimeseriesBuilder;
import io.kafka.demos.streams.wikimedia.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
    ...
    static {
        ...
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "[::1]:9092");
